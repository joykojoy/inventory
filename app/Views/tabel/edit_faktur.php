    ...
    <tbody>
        ...
        foreach ($data as $d) : ?>
            <tr>
                ...
                <td class="text-end">
                    <button type="button" class="btn btn-outline-danger btn-delete-fedit-faktur" title="Hapus" data-id="<?= $d->id ?>">
...
<script>
    $(".btn-delete-fedit-faktur").click(function() {
        let id = $(this).data('id')
        $.ajax({
            url: "/admin/barangmasuk/delete_fedit_faktur",
            data: {
                id: id
            },
            method: "post",
