...
<section class="section">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-6">
                    <button class="btn bg-indigo text-light btn-fentri-brgmasuk mb-2">
                    ...
                    <form action="" method="get" id="searchForm" class="d-flex justify-content-end">
                        <div style="width: 33%;">
                            <input type="text" name="search" id="searchInput" class="form-control"
                                   placeholder="Cari barang masuk..." value="<?= isset($keyword) ? $keyword : '' ?>"
                                   oninput="handleSearch(this.value)">
                        </div>
                        <?php if(isset($keyword) && !empty($keyword)): ?>
                            <a href="<?= site_url('admin/barangmasuk') ?>" class="btn btn-secondary ms-2">Reset</a>
                        <?php endif; ?>
                    </form>
                </div>
            </div>

            <?= $this->include('tabel/brgmasuk') ?>
            <div class="div-terimabrg"></div>
